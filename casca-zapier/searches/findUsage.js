...
module.exports = {
  key: 'find_usage', noun: 'Usage Stats',
  display: { label: 'Find Usage Stats', description: 'Look up your current plan, token usage, and balance.' },
  operation: {
    perform, inputFields: [],
    sample: { id: 'user-001', email: 'user@company.com', plan_name: 'Starter', balance_credits: 45, cycle_used_tokens: 5200000, included_m_tokens: 10 },
    outputFields: [
